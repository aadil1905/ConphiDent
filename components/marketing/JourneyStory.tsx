...
const stages: Array<{
  ...
  { label: "Lab & imaging", problem: "The crown at the lab and the X-ray it was planned from end up in two systems that never meet.", feature: "Lab cases carry material, shade, due date and status; radiographs stay attached to the same patient and compare side by side.", outcome: "Work that leaves the clinic still belongs to the record.", visual: "laboratory" },
