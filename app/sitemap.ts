...
export default function sitemap(): MetadataRoute.Sitemap { return [
  ...
  { url: `${siteUrl}/whatsapp`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  { url: `${siteUrl}/security`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
